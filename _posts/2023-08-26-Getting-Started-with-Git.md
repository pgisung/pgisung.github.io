...
> 1. [Windows 환경에서 Git 설치 방법](#windows-환경에서-git-설치-방법)
- [설치 파일 다운로드](#설치-파일-다운로드)
- [설치](#설치)
- [설치 확인](#설치-확인)
2. [Mac 환경에서 Git 설치 방법](#mac-환경에서-git-설치-방법)
- [Homebrew 설치](#homebrew-설치)
- [Git 설치](#git-설치)
3. [Git 입문하기](#git-입문하기)
- [Git 명령 구조](#git-명령-구조)
- [명령어 옵션의 종류](#명령어-옵션의-종류)
4. [Git 환경설정](#git-환경설정)
- [환경변수 추가](#환경변수-추가)
- [환경변수 삭제](#환경변수-삭제)
- [환경변수 목록](#환경변수-목록)
- [사용자 등록](#사용자-등록)
- [전역 환경설정 옵션](#전역-환경설정-옵션)
- [Commit 템플릿 설정](#commit-템플릿-설정)
- [Git 색상 출력 자동 설정](#git-색상-출력-자동-설정)
- [자격 증명 캐시](#자격-증명-캐시)
- [Pull 명령 기본값](#pull-명령-기본값)
- [Branch 이름 기본값](#branch-이름-기본값)
- [Git의 코어 에디터 설정](#git의-코어-에디터-설정)
- [단축 명령어 설정](#단축-명령어-설정)
...
### Pull 명령 기본값
<span style="color: #8D4801">**git pull 명령을 실행할 때 rebase**</span>를 사용하지 않고 바로 merge를 수행하도록 지정한다. **위의 Windows 환경에서 Git 설치 과정 중** [**12번 과정**](#git-setup-12 "12번 과정으로 이동")**과 동일한 환경변수이다.**
```bash
...
### Branch 이름 기본값
git 저장소를 초기화할 때 <span style="color: #8D4801">**브랜치의 기본명칭**</span>을 설정할 수 있다. (기본값은 master이다.) **위의 Windows 환경에서 Git 설치 과정 중** [**6번 과정**](#git-setup-6 "6번 과정으로 이동")**과 동일한 환경변수이다.**
```bash
...
[git-official-website-link]: https://git-scm.com "Git 공식 웹사이트로 이동"
[homebrew-official-website-link]: https://brew.sh "Homebrew 공식 웹사이트로 이동"