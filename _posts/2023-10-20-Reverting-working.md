...
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-reset-soft.jpg" title="Git command to reset the commit with soft option" alt="Git command to reset the commit with soft option">
...
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-reset-mixed.jpg" title="Git command to reset the commit with mixed option" alt="Git command to reset the commit with mixed option">
...
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-reset-hard.jpg" title="Git command to reset the commit with hard option" alt="Git command to reset the commit with hard option">
...
```
  ...
  - 명령어 실행 전
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/before-git-command-reset-merge.jpg" title="Git log before git command reset --merge" alt="Git log before git command reset --merge">

  - 명령어 실행
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-reset-merge.jpg" title="Git command to reset merge commit" alt="Git command to reset merge commit">

  - 명령어 실행 후
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/after-git-command-reset-merge.jpg" title="Git log after git command reset --merge" alt="Git log after git command reset --merge">
...
- 명령어 실행
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-revert.jpg" title="Git command to revert the commit" alt="Git command to revert the commit">

- 명령어 실행 후
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/after-git-command-revert.jpg" title="Git log after git command revert" alt="Git log after git command revert">
...
```
  ...
  - 명령어 실행 전
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/before-git-command-revert-commit-range.jpg" title="Git log before git command revert range of commits" alt="Git log before git command revert range of commits">

  - 명령어 실행
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-revert-commit-range.jpg" title="Git command to revert range of commits" alt="Git command to revert range of commits">

  - 명령어 실행 후
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/after-git-command-revert-commit-range.jpg" title="Git log after git command revert range of commits" alt="Git log after git command revert range of commits">
...
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-revert-continue.jpg" title="Git command to continue reverting" alt="Git command to continue reverting">
...
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-revert-skip.jpg" title="Git command to skip reverting" alt="Git command to skip reverting">
...
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-revert-abort.jpg" title="Git command to abort reverting" alt="Git command to abort reverting">
...
```
  ...
  - 명령어 실행 전
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/before-git-command-revert-mainline.jpg" title="Git log before git command revert --mainline" alt="Git log before git command revert --mainline">

  - 명령어 실행
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-revert-mainline.jpg" title="Git command to revert merge commit" alt="Git command to revert merge commit">

  - 명령어 실행 후
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/after-git-command-revert-mainline.jpg" title="Git log after git command revert --mainline" alt="Git log after git command revert --mainline">
...
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-reflog.jpg" title="Git command to show list of reference log" alt="Git command to show list of reference log">
...
git log -g
```
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-log-g.jpg" title="Git command to show list of reference log in detail" alt="Git command to show list of reference log in detail">
...
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-show-reference-log.jpg" title="Git command to show specified log for filtered reference" alt="Git command to show specified log for filtered reference">
...
- 명령어 실행 전
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/before-git-command-reset-hard-ref-commit.jpg" title="Git reference log before git command reset --hard <ref>@{commit}" alt="Git reference log before git command reset --hard <ref>@{commit}">

- 명령어 실행
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/git-command-reset-hard-ref-commit.jpg" title="Git command to reset to the reference commit" alt="Git command to reset to the reference commit">

- 명령어 실행 후
<img src="{{site.baseurl}}/images/posts/2023-10-20-Reverting-working/after-git-command-reset-hard-ref-commit.jpg" title="Git reference log after git command reset --hard <ref>@{commit}" alt="Git reference log after git command reset --hard <ref>@{commit}">
