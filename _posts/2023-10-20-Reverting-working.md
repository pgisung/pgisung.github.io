...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-rm-cached.jpg" alt="파일의 추적 상태를 추적하지 않은 상태로 변경하는 명령어">
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-restore-staged.jpg" alt="파일의 스테이지 상태를 스테이징 되지 않은 상태로 변경하는 명령어">
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-reset-HEAD.jpg" alt="지정된 특정 커밋을 기준으로 복귀시키는 명령어">
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-restore.jpg" alt="파일을 바로 이전 커밋의 상태 즉, 수정 전 상태로 되돌리는 명령어">
...
git reset <옵션> <커밋 범위>
```
<center><img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/reference-of-reset-command.webp" alt="리셋에 대한 이해를 돕기 위한 그림"></center>
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-reset-soft.jpg" alt="취소된 커밋 기록의 스테이지 상태까지 복원하는 옵션">
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-reset-mixed.jpg" alt="취소된 커밋 기록을 작업 디렉토리로 복원하는 옵션">
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-reset-hard.jpg" alt="취소된 커밋 기록을 모두 삭제하는 옵션">
...
```
  ...
  - 명령어 실행 전
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/before-git-command-reset-merge.jpg" alt="3-way 병합 커밋을 취소하고 병합 이전의 상태로 되돌리는 명령어 실행 전">

  - 명령어 실행
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-reset-merge.jpg" alt="3-way 병합 커밋을 취소하고 병합 이전의 상태로 되돌리는 명령어 실행">

  - 명령어 실행 후
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/after-git-command-reset-merge.jpg" alt="3-way 병합 커밋을 취소하고 병합 이전의 상태로 되돌리는 명령어 실행 후">
...
```
- 명령어 실행 전
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/before-git-command-revert.jpg" alt="기존 커밋을 보존하면서 되돌리기 작업에 대한 새로운 커밋을 생성하는 명령어 실행 전">

- 명령어 실행
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-revert.jpg" alt="기존 커밋을 보존하면서 되돌리기 작업에 대한 새로운 커밋을 생성하는 명령어 실행">

- 명령어 실행 후
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/after-git-command-revert.jpg" alt="기존 커밋을 보존하면서 되돌리기 작업에 대한 새로운 커밋을 생성하는 명령어 실행 후">
...
```
  ...
  - 명령어 실행 전
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/before-git-command-revert-commit-range.jpg" alt="범위 안의 여러 개의 커밋을 리버트하는 명령어 실행 전">

  - 명령어 실행
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-revert-commit-range.jpg" alt="범위 안의 여러 개의 커밋을 리버트하는 명령어 실행">

  - 명령어 실행 후
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/after-git-command-revert-commit-range.jpg" alt="범위 안의 여러 개의 커밋을 리버트하는 명령어 실행 후">
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-revert-continue.jpg" alt="충돌 등이 발생했을 때 문제 해결 후 리버트를 계속 진행하는 옵션">
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-revert-skip.jpg" alt="리버트 중 충돌 등이 발생한 경우 특정 커밋의 충돌을 건너뛰고 리버트를 진행하는 옵션">
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-revert-abort.jpg" alt="현재 진행 중인 리버트를 중지하는 옵션">
...
```
  ...
  - 명령어 실행 전
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/before-git-command-revert-mainline.jpg" alt="병합 커밋에 대하여 복귀할 브랜치의 내용을 선택하는 명령어 실행 전">

  - 명령어 실행
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-revert-mainline.jpg" alt="병합 커밋에 대하여 복귀할 브랜치의 내용을 선택하는 명령어 실행">

  - 명령어 실행 후
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/after-git-command-revert-mainline.jpg" alt="병합 커밋에 대하여 복귀할 브랜치의 내용을 선택하는 명령어 실행 후">
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-reflog.jpg" alt="참조들에 대하여 수행된 명령어의 기록을 목록으로 확인하는 명령어">
...
git log -g
```
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-log-g.jpg" alt="참조 기록의 목록을 자세하게 보여주는 명령어">
...
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-show-reference-log.jpg" alt="특정 참조 기록의 상세 정보를 확인하는 명령어">
...
- 명령어 실행 전
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/before-git-command-reset-hard-ref-commit.jpg" alt="특정 명령어의 사용 시점으로 되돌리는 명령어 실행 전">

- 명령어 실행
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/git-command-reset-hard-ref-commit.jpg" alt="특정 명령어의 사용 시점으로 되돌리는 명령어 실행">

- 명령어 실행 후
<img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2023-10-20-Reverting-working/after-git-command-reset-hard-ref-commit.jpg" alt="특정 명령어의 사용 시점으로 되돌리는 명령어 실행 후">
