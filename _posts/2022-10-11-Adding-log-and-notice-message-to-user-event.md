...
> 1. [작성 동기](#작성-동기)
2. [기능 구상](#기능-구상)
3. [실행될 함수를 구현하자](#실행될-함수를-구현하자)
- [NumericUpDown ValueChanged 이벤트](#numericupdown-valuechanged-이벤트)
- [CheckBox CheckedChanged 이벤트](#checkbox-checkedchanged-이벤트)
- [Button Click 이벤트](#button-click-이벤트)

---

## 작성 동기
[이전 포스트]({{ site.baseurl }}/csharp/2022/05/16/Saving-various-types-of-model-into-files-using-reflection/#작성-동기 "이전 포스트로 이동")의 작성 동기와 같이 작업자가 프로그램의 무엇인가를 잘못 변경하고 그로 인해 생산에 오류가 발생했을 때 예상하지 못한 <span style="color: #8D4801">**오류 발생의 원인을 찾기 어려워서**</span> 힘들었던 경험이 있었고 또한 <span style="color: #8D4801">**책임 소재를 파악하기 어려워**</span> 결국 프로그램 개발자에게 화살을 돌리는 상황을 적지 않게 맞닥뜨렸었다. 이러한 상황에 최소한의 대응을 하기 위해 사용자 이벤트에 로그 추가를 결정했다.

<center>
  <img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2022-10-11-Adding-log-and-notice-message-to-user-event/case-there-is-no-notice-message.gif" alt="Example for the case there is no notice message to click event" width="45%">
  <img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2022-10-11-Adding-log-and-notice-message-to-user-event/case-there-is-notice-message.gif" alt="Example for the case there is notice message to click event" width="45%">
</center>
<br>
