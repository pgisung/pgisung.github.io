...
<center>
  <img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2022-10-11-Adding-log-and-notice-message-to-user-event/case-there-is-no-notice-message.gif" title="Example for the case there is no notice message to click event" alt="Example for the case there is no notice message to click event" width="45%">
  <img data-src="https://pub-056cbc77efa44842832acb3cdce331b6.r2.dev/2022-10-11-Adding-log-and-notice-message-to-user-event/case-there-is-notice-message.gif" title="Example for the case there is notice message to click event" alt="Example for the case there is notice message to click event" width="45%">
</center>
<br>
